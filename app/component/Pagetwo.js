...
import numbeingss from './image/image5 (2).png';
  ...
  useEffect(() => {
    ...
    return (
        <div id='About' ref={wrapperRef} className='py-[24px] sm:py-[32px] md:py-[36px] lg:py-[40px] xl:py-[48px] 2xl:py-[64px] px-6 sm:px-0 relative'>
          <Image className='w-1/2 absolute top-0 left-0 ' src={lineone} alt='Loadding...'/>
          <Image className='w-1/2 absolute top-0 right-0' src={linetwo} alt='Loadding...'/>
           <div className='container mx-auto'>
              <div><h2 className='ourpratens text-[11px] sm:text-[12px] md:text-[13px] lg:text-[14px] xl:text-[15px] 2xl:text-[16px] pb-[11px] sm:pb-[12px] md:pb-[13px] lg:pb-[14px] xl:pb-[15px] 2xl:pb-[16px]'>Our Partners</h2></div>
              <div className='grid grid-cols-2 md:grid-cols-4 justify-center items-center gap-[13px] sm:gap-[14px] md:gap-[15px] lg:gap-[16px] xl:gap-[20px] 2xl:gap-[24px] px-[24px] sm:px-[100px] md:px-[150px] lg:px-[200px] xl:px-[250px] 2xl:px-[308px] '>
